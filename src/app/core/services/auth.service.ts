...
export class AuthService {
  ...
  constructor(private router: Router) {
    // Restore from localStorage (persists across tabs/sessions)
    ...
    const storedRealm = localStorage.getItem('aes_active_realm');
    if (storedRealm && storedRealm !== 'ALL') this._realm.set(storedRealm);
